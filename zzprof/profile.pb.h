...
class Profile PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_profile_2eproto);
    return ::descriptor_table_profile_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::perftools::profiles::ValueType* release_period_type();
...
inline ::perftools::profiles::ValueType* Profile::_internal_mutable_period_type() {
  ...
  if (period_type_ == nullptr) {
    auto* p = CreateMaybeMessage<::perftools::profiles::ValueType>(GetArena());
    period_type_ = p;
  }
  return period_type_;
}
